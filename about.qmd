...
Westman Naturalists Inc. is incorporated as a non-profit corporation and organized by a team of volunteers.

Everyone is welcome to our events, but you'll have to be [a member](membership.html) if you want to join the board!
Check out [our bylaws](bylaws.html) to see what we're all about, and feel free to send
us [an email](mailto:contact@westmannaturalists.ca) with any questions.
...
::: {.column-margin}
![](images/board/alex.jpg){fig-alt="Alex Koiter" title="Alex Koiter"}
:::
...
## Jen Wasko
::: {.column-margin}
![](images/board/jen.jpg){fig-alt="Jen Wasko" title="Jen Wasko"}
:::
...
::: {.column-margin}
![](images/board/kathryn.jpg){fig-alt="Kathryn Hyndman" title="Kathryn Hyndman"}
:::
...
## Carson Kearns
::: {.column-margin}
![](images/board/carson.jpg){fig-alt="Carson Kearns" title="Carson Kearns"}
:::
...
position with Parks Canada in the 1990s and early 2000s encouraged him to
...
skiing and snowshoeing in the winter with his three grown children and their
partners, his dogs, and his wife.

## Steffi LaZerte

::: {.column-margin}
![](images/board/steffi.jpg){fig-alt="Steffi LaZerte" title="Steffi LaZerte"}
:::
...
::: {.column-margin}
![](images/board/glennis.jpg){fig-alt="Glennis Lewis" title="Glennis Lewis"}
:::
